...
Our merged checkpoints can be obtained from [qwen2.5_fqFirst](https://huggingface.co/xxxx/CABSplus_qwen2.5_fqFirst) and [qwen2.5_TsunamiFirst](https://huggingface.co/xxxxx/CABSplus_qwen2.5_TsunamiFirst).
